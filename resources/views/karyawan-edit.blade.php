    ...
    <body>
        ...
        <div class="row justify-content-center pt-3">
            <div class="col-lg-8 col-md-8">
                <div class="card">
                    <form action="/karyawan/{{ $pengajuan['id'] }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between mb-3">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="ket" name="keterangan_karyawan"
                                        value="{{ $pengajuan['keterangan_karyawan'] }}">
                                </div>
                            </div>
                            <div class="row justify-content-between">
                                ...
                                <div class="col-5">
                                    <div class="d-grid gap-2 mt-3">
                                        <a class="btn btn-danger" type="button" href="/karyawan-detail">Close</a>
                                    </div>
                                </div>
                            </div>
                        </div>
